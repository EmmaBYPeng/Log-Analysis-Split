...
class ArmFlow extends Base {
  ...
  def toRow(line: Array[String]): Row = {
    ...
    return Row(gameId, accountType, worldId, dtEventTime, iEventId, vVersionId, vUin, vUin, iRoleId, vRoleName, iRoleJob, iRoleGender, iRoleLevel,
               iRoleReputationLevel, vRoleElse1, vRoleElse2, vClientIP, iArmId, iStar, iLevel, iArmType, iArmNum, iArmGuide, jEquipProperty, 
               iFlowDirection, iAction)
  }
}